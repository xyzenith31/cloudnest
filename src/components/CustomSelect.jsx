  ...
  return (
    <div className="relative">
      ...
      <Listbox value={selected} onChange={onChange}>
        {/* PERBAIKAN: Tombol akan berubah warna jika sudah ada pilihan */}
        <Listbox.Button 
        ...
        >
          ...
          <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
            {/* PERBAIKAN: Ubah warna ikon panah agar kontras */}
            ...
            {options.map((option) => (
              ...
              option.id > 0 && (
                <Listbox.Option
                  key={option.id}
                  className={({ active }) =>
                    // PERBAIKAN: Warna saat hover (active) menjadi biru muda
