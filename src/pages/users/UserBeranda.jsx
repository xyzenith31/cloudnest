...
import {
    FiStar, FiClock, FiFile, FiHardDrive, FiFolder, FiMusic, FiFileText, FiCpu, FiArchive
} from 'react-icons/fi';
// [PENAMBAHAN] Mengimpor ikon yang lebih spesifik
import {
    FaFilePdf, FaFileWord, FaFileImage, FaFileArchive, FaFileVideo,
    FaFileExcel, FaFilePowerpoint, FaAndroid, FaWindows, FaApple, FaLinux
} from 'react-icons/fa';
...
// [PERUBAHAN] Fungsi getFileIcon yang diperbarui agar lebih detail
const getFileIcon = (file) => {
    if (!file) return <FiFile className="text-gray-500" />;
    ...
    switch (file.category) {
        ...
        case 'music':
            return <FiMusic className="text-pink-500" />;
        case 'video':
        ...
        case 'aplikasi':
            switch (extension) {
                case '.exe':
                case '.msi':
                    return <FaWindows className="text-sky-500" />;
                case '.dmg':
                    return <FaApple className="text-gray-600" />;
                case '.deb':
                    return <FaLinux className="text-orange-400" />;
                case '.ipa':
                     return <FaApple className="text-blue-400" />;
                default:
                    return <FiCpu className="text-gray-700" />;
            }
        default:
